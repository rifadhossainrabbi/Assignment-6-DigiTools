...
const RatingSection = () => {
  return (
    <div className="w-full mt-[50px] min-h-[20vh] bg-gradient-to-r from-[#4F39F6] to-[#9514FA]">
      <div className="max-w-11/12 md:max-w-10/12 lg:max-w-9/12 mx-auto flex flex-col md:flex-row md:flex-wrap justify-center items-center py-14 text-white gap-32">
        <div className="">
