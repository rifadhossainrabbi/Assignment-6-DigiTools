...
const HeroSection = () => {
  return (
    <div className="min-w-full min-h-[30vh] mt-[85px]">
      <div className="max-w-11/12 md:max-w-10/12 lg:max-w-9/12 mx-auto flex flex-col md:flex-row-reverse justify-between items-center gap-[60px]">
        <img
          src={BannerImg}
        ...
        <div className="text-center md:text-left lg:text-left">
          ...
          <button className="btn btn-primary bg-linear-to-r from-[#4F39F6] to-[#9514FA] rounded-3xl  transition-transform hover:-translate-y-2 duration-300 ease-in-out">
            Explore Products
          </button>

          <button className="btn ml-2 border border-[#9514FA] rounded-3xl bg-white transition-transform hover:-translate-y-2 duration-300 ease-in-out">
            <span>
              <CiPlay1 />
            </span>
            <span className=" bg-gradient-to-r from-[#4F39F6] to-[#9514FA] bg-clip-text text-transparent">
