...
const StartedSection = () => {
  return (
    <div className="w-full bg-[#F9FAFC] py-24">
      ...
      <div className="max-w-11/12 md:max-w-10/12 lg:max-w-9/12 mx-auto grid grid-cols-1 md:grid-cols-3 justify-items-center items-center gap-16">
        <div className="card my-14 bg-base-100 shadow-sm p-3 rounded-2xl w-full max-w-sm">
